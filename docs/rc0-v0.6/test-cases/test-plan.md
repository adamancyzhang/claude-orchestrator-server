...
| 6. 评估器 fallback（RC0 新增） | `tc-06-evaluator-fallback.md` | ✓ | ✓ | — | — | ✓ |

`tc-06` 专门覆盖 RC0 修复 R-03（评估器三连失败一律 reject）；`tc-02` / `tc-03` / `tc-04` 含 RC0 修复 R-01 / R-04 / R-05 / R-06 / R-02 的子用例（详见各文件 "RC0 新增" 区块）。
