...
// Test with the exact payload from chain-router.ts
const input: CreateTaskInput = {
  title: "Test task",
  description: null, // This might be the issue
  criteria: null, // This might be the issue
  priority: 1,
  link: null,
  chain_id: "test-chain-id",
  created_by: "leader-id",
  created_by_name: null, // This might be the issue
};

console.log("Testing with null values in optional fields:");
