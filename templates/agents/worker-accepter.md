...
### Session Memory
Read `{{co_root}}/docs/{{name}}/CLAUDE.md` at task start. Append the GO / NO-GO decision and the chain_id to the dated CLAUDE.md under `{{co_root}}/docs/{{name}}/<today>/CLAUDE.md` at task end.
