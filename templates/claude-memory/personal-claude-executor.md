...
1. **Trace** — Read the Planner's blueprint from `{{co_root}}/docs/{planner_name}/YYYY-MM-DD/blueprint.md`. The chain-shared cache copy sits at `{{upstream_plan_artifact}}` if your worktree lacks it. Extract every implementable requirement as a checklist.
